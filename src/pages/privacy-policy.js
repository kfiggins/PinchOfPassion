...
export default function privacyPolicy({ data, location }) {
  ...
  return (
    <Layout location={location} title={siteTitle}>
      ...
      <p>
        It is A Pinch Of Passion's policy to respect your privacy regarding any
        information we may collect while operating our website. This Privacy
        Policy applies to
        <a href="https://apinchofpassion.com/">https://apinchofpassion.com/</a>
        (hereinafter, "us", "we", or "https://apinchofpassion.com/"). We respect
      ...
      <p>
        Like most website operators, A Pinch Of Passion collects
        ...
        request. A Pinch Of Passion's purpose in collecting non-personally
        identifying information is to better understand how A Pinch Of Passion's
        visitors use its website. From time to time, A Pinch Of Passion may
      ...
      <p>
        A Pinch Of Passion also collects potentially personally-identifying
        information like Internet Protocol (IP) addresses for logged in users
        and for users leaving comments on https://apinchofpassion.com/ blog
        posts. A Pinch Of Passion only discloses logged in user and commenter IP
        addresses under the same circumstances that it uses and discloses
        personally-identifying information as described below.
      </p>
      <h2>Gathering of Personally-Identifying Information</h2>
      <p>
        Certain visitors to A Pinch Of Passion's websites choose to interact
        with A Pinch Of Passion in ways that require A Pinch Of Passion to
        gather personally-identifying information. The amount and type of
        information that A Pinch Of Passion gathers depends on the nature of the
        interaction. For example, we ask visitors who sign up for a blog at
        https://apinchofpassion.com/ to provide a username and email address.
      </p>
      <h2>Security</h2>
      <p>
      ...
      <p>
        ...
        Privacy Policy covers the use of cookies by A Pinch Of Passion and does
      ...
      <p>
        A Pinch Of Passion may collect statistics about the behavior of visitors
        to its website. A Pinch Of Passion may display this information publicly
        or provide it to others. However, A Pinch Of Passion does not disclose
        your personally-identifying information.
      </p>
      <h2>Privacy Policy Changes</h2>
      <p>
        Although most changes are likely to be minor, A Pinch Of Passion may
        change its Privacy Policy from time to time, and in A Pinch Of Passion's
        sole discretion. A Pinch Of Passion encourages visitors to frequently
